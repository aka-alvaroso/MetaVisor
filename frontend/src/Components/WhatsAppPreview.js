...
function WhatsAppPreview ({ metadata }) {
  ...
  return (
    <div className='w-full flex flex-col justify-center items-center'>
      ...
      <h2 className='font-bold text-lg mt-10 text-center'>Previsualización en WhatsApp Desktop</h2>
      ...
      <div className="w-11/12 p-4 border rounded-lg sm:w-9/12 md:w-1/2 lg:w-4/12">
        <div className="flex bg-neutral-100 rounded-md">
          ...
          <div className='w-8/12 flex flex-col ml-2 md:w-9/12'>
      ...
      <h2 className='font-bold text-lg mt-10 text-center'>Previsualización en WhatsApp Web</h2>
